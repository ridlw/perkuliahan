...
@Component({
  selector: 'app-jadwal-perkuliahan-mhs',
  templateUrl: './jadwal-perkuliahan-mhs.component.html',
  styleUrls: ['./jadwal-perkuliahan-mhs.component.css']
})
export class JadwalPerkuliahanMhsComponent {
  jadwal : any;
  total=0;    
  private value:any;
  nrp : any ;
  ...
  findTotalSKS(data:any){    
    ...
    for(let j=0;j<data.length;j++){
      if (this.value[j].id_jenis_jadwal =="K") {
